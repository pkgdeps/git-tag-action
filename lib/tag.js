...
exports.tag = (octokit, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        try {
            ...
            const tagRes = yield octokit.git.createTag({
            ...
            const refRes = yield octokit.git.createRef({
                owner: options.owner,
                repo: options.repo,
                sha: tagRes.data.sha,
                ref: `refs/tags/${options.gitTagName}`
            ...
            core.error("create tag and get unexpected error: " + (createTagError === null || createTagError === void 0 ? void 0 : createTagError.message));
        }
    }
});
